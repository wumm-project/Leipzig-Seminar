...
\usepackage[russian,main=german]{babel}
...
Probleme mit den Übersetzungen:


Analysis of problem situation (ist englisch)

Abschnitte im TRIZ-Trainer:

1. Analyse der Problemsituation
1.1. Präzisierung der Umstände
Nützliches Produkt
...
Eine Wirkung, die nicht ohne Probleme abgeschlossen werden kann
Konfliktstruktur
Ort des Konflikts
Konfliktzeit
1.3. Aufstellen einer Hypothese
Konfliktursachen
Konfliktlösungshypothese
1.4. Bedingungen der Aufgabe
Formulierung der Bedingungen der Aufgabe
