...
if __name__ == '__main__':
    ...
    # Test eines der Probetexte aus den 40 Prinzipien
    abstract_de_3 =  """Prinzip der Anwendung von Wärmedehnung" -- Die Wärmedehnung oder -verdichtung von Werkstoffen ist auszunutzen." , "Es sind mehrere Werkstoffe mit unterschiedlicher Wärmedehnungszahl zu benutzen." ."""
    print(tfidf(abstract_de_3, methoden, get_stop_words('de')))
