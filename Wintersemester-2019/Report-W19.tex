...
\section{\raggedright Ziel und Methodik des Seminars}
...
\section{\raggedright Systembegriff in der Theorie dynamischer Systeme (Gräbe)}
...
\section{\raggedright Einführung in Systemwissenschaft, Nachhaltigkeit und Allgemeine
...
\section{\raggedright Zum Verhältnis von Systembegriff und Wirklichkeit (Kleemann)}
...
\section{\raggedright Systembegriffe in der Praxis (Gräbe)}
...
\section{\raggedright Organisation in lebenden Systemen (Laforet)}
...
\section{\raggedright Resilienz (Laforet, Lautenschläger)}
...
\section{\raggedright Organisation in komplexen adaptiven Systemen (IIRM)}
...
\section{\raggedright Institutionelle Analyse von sozio-ökologischen Systemen
  (IIRM)}
...
\section{\raggedright  Sozio-technische Systeme (STS) und
...
\section{\raggedright Systembegriff in der TRIZ-Methodik (Gräbe)}
...
\section{\raggedright  TRIZ und Systematische Innovationen in komplexen
  Umgebungen (Gräbe)} 
...
\section{\raggedright Gesetze und Trends der Entwicklung technischer Systeme
  (Gräbe)} 
...
Überlegungen werden in \cite{Rubin2019} weiter detailliert.  Wie in (TESE)
werden die Gesetze in eine baumartige Kausalstruktur gebracht (präziser: in
die Struktur eines gerichteten azylischen Graphen) und in einem zweiten
Schritt die Verbindung zu den TRIZ-Standards hergestellt, die als operationale
...
\section{\raggedright Wie entwickeln sich technische Systeme}
