...
\item Holland, John H. (2006). Studying complex adaptive systems. In: Journal
  ...
  \url{https://link.springer.com/article/10.1007/s11424-006-0001-z}
  (Verlagsintern)
...
\item Jooß, Christian (2017). Selbstorganisation der Materie.  Verlag Neuer
  Weg, Essen.
\item Khomenko, Nikolai (2005). Super-short introduction into Classical TRIZ
  and OTSM. In: Khomenko-Archiv. 
  \url{https://otsm-triz.org/en/content/super_short_intr_en}
\item Khomenko, Nikolai (2008). Fundamentals of Classical TRIZ. In:
  Khomenko-Archiv.
  \url{https://otsm-triz.org/en/content/nkhomenko-fundamentals-classical-triz}
...
\item Mann, Darrell (2019a).  Systematic innovation in complex
  environments. Proceedings of the TRIZ Summit 2019 Minsk.\\
  \url{https://triz-summit.ru/file.php/id/f304797-file-original.pdf} 
\item Mann, Darrell (2019b).  COBRA+: A systematic (service) innovation
  process.  Proceedings of the TRIZ Summit 2019 Minsk.\\
  \url{https://triz-summit.ru/file.php/id/f304816-file-original.pdf}
