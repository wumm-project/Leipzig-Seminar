...
\item Four "goals" are defined
  \begin{itemize}
  \item To own the intellectual property known as "The On-Line Encyclopedia of
...
\item Hence the question of the identification of "Customer noeeds" (what?)
...
\item[1.] The classical owner-managed company.
  \begin{itemize}
  \item With the notions “brilliant inventor” and “wage labourer”.
...
\item[2.] Stakeholder-driven company forms such as Stock Corporation.
  \begin{itemize}
  \item With the notion “legal person”. Copyright as economically usable legal
...
\item[3.] Network cooperation.
  ...
  \item Copyright law as a functional basis of the \emph{internal
    relationship} required to reproducte the infrastructure. Copyleft, open
    culture.
  \end{itemize}
