...
\begin{document}
    ...
    The \texttt{tc:TechniquesofModification} is this set of methods that are 
    derived from certain LETS or so called trends occuring in technical systems 
    that prescribe certain proceedings.[source]
