...
\title{Modellierung nachhaltiger Systeme\\ und Semantic Web\vskip2em}
...
\section{Grundlagen}
\begin{frame}\frametitle{Technische Systeme in der TRIZ}
...
\end{alertblock}
\end{frame}
\begin{frame}\frametitle{Erste Näherung}
...
\end{frame}
\begin{frame}\frametitle{Funktion des Begriffs eines TS}.
